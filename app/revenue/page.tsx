...
const LEDGER = [
  { date: '2026-04-14', action: 'Reactivación · Dormidos', sent: 47, converted: 4, revenue: 189_000 },
  { date: '2026-04-13', action: 'Segunda visita · Nuevos', sent: 23, converted: 6, revenue: 278_000 },
  { date: '2026-04-12', action: 'Llenar mesas · Jueves cena', sent: 31, converted: 9, revenue: 402_000 },
  { date: '2026-04-11', action: 'Reactivación · En riesgo', sent: 18, converted: 3, revenue: 132_000 },
  { date: '2026-04-10', action: 'VIP · Evento temporada', sent: 12, converted: 8, revenue: 624_000 },
  { date: '2026-04-09', action: 'Reactivación · Dormidos', sent: 52, converted: 5, revenue: 218_000 },
  { date: '2026-04-08', action: 'Post-visita · Reseñas', sent: 28, converted: 0, revenue: 0 },
];
  ...
  return (
    <AppShell>
      ...
      <section className="editorial-container pt-20 pb-16">
        <Label className="mb-6">Revenue generado · últimos 7 días</Label>
        <div
        ...
        >
          plata nueva en caja, sin descuentos, sin promos, sin campañas masivas.
        </p>
      </section>

      <section className="editorial-container pb-24 grid grid-cols-3 gap-0 border-y border-hairline">
        <Stat label="Mensajes enviados" value={totalSent} />
        <Stat label="Conversiones" value={totalConverted} />
        <Stat label="Tasa" value={`${((totalConverted / totalSent) * 100).toFixed(1)}%`} />
      </section>
