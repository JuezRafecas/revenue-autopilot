...
export const SEGMENT_CONFIG: Record<Segment, SegmentConfig> = {
  vip: {
    key: 'vip',
    label: 'VIP',
    description: 'Alta frecuencia, alto valor — motor del negocio',
  ...
  active: {
    key: 'active',
    label: 'Activos',
    description: 'Visitan con frecuencia — base saludable',
  ...
  new: {
    key: 'new',
    label: 'Nuevos',
    description: 'Primera visita reciente — punto crítico de fuga',
  ...
  at_risk: {
    key: 'at_risk',
    label: 'En Riesgo',
    description: 'Eran activos, están dejando de venir',
  ...
  dormant: {
    key: 'dormant',
    label: 'Dormidos',
    description: 'No visitan hace rato — la bolsa más grande de revenue perdido',
  ...
  lead: {
    key: 'lead',
    label: 'Leads',
    description: 'Interactuaron pero nunca pisaron el salón',
